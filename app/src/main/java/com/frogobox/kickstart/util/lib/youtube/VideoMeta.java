...
public class VideoMeta {
    ...
    public boolean equals(Object o) {
        ...
        if (!Objects.equals(videoId, videoMeta.videoId))
            return false;
        if (!Objects.equals(title, videoMeta.title)) return false;
        if (!Objects.equals(author, videoMeta.author))
            return false;
        return Objects.equals(channelId, videoMeta.channelId);
